...
def main():
    ...
    for dt in dates:
                ...
                if volume_state == "NONE" and bottom_volume:
                    ...
                    if low.loc[dt] < volume_event_low * (1 + INVALIDATION_DROP):
                        ...
                        if soldier_start > volume_event_date:
                            ...
                            trades.append({
                                "trade_date": dt,
                                "action": "SEQUENCE_CONFIRMED_OPEN_CPPI",
                                "theme": current_theme,
        ...
        if current_theme is None:
            ...
            cycle_weight = max(base_weight, cppi_weight)
        else:
            cycle_weight = base_weight
    ...
    summary = pd.DataFrame([{
        "strategy": "BASE_VOLUME_SEQUENCE_CPPI",
        ...
        "num_sequence_confirms": int((trades_df["action"] == "SEQUENCE_CONFIRMED_OPEN_CPPI").sum()) if not trades_df.empty else 0,
