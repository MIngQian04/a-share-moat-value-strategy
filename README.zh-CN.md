...
一个从全 A 股中寻找“估值具有安全边际，同时具备长期价值捕获能力”的投资研究框架。

系统先通过所有者收益、现金流、资产负债表和五档 DCF 建立估值边界，再研究公司是否依靠品牌、成本、技术、渠道、稀缺资源、转换成本或全球产业地位形成可验证、可持续且可被证伪的定价权。

这里的“全球定价权”不等于海外收入高，也不意味着投资全球股票，而是判断 A 股公司能否在更广泛的竞争环境中保留利润、转嫁成本并持续获取价值。
...
- **定价权证据：** 当前维护 10 条用于验证长期价值捕获的可证伪护城河注册表记录，并有雷达健康快照。
...
| 排名 | 代码 | 公司 | 行业 | 评分 | 基准 DCF 安全边际 | 财务/数据门 | 筛选状态 | 定价权/护城河代理状态 |
| ---: | --- | --- | --- | ---: | ---: | --- | --- | --- |
...
> **状态说明：** `WATCH` 表示保留在研究/观察队列；`DEFENSIVE_ELIGIBLE` 表示通过当前稳定锚仓全部门槛；`PASS_CASH_EARNINGS` 表示归一化所有者收益和归一化 FCF 通过现金收益门。`BRAND_PRICING_POWER_PROXY` 与 `SCALE_COST_LEADER_PROXY` 是机器代理；`POSITION_ONLY_REVIEW` 表示只通过行业位置代理；`NO_POSITION_EVIDENCE` 表示没有通过位置型代理。以上代理状态都不等于人工确认的定价权或护城河证据。

## 这个系统如何寻找机会

系统不是先指定热门行业再寻找股票，也不是只根据低估值机械买入，而是连续回答两个问题：当前价格是否提供足够的安全边际，以及公司能否依靠持久的定价权捕获并保留价值。它将跨行业估值筛选与未来需求研究交叉，寻找当前预期较低、但未来利润池可能改善的公司。
...
第一条腿从全 A 股寻找估值支持、所有者收益、现金流转化、资产负债表质量、生存能力、数据完整性和行业位置；第二条腿研究政策、产业规划、需求、瓶颈和利润池变化，再验证结构性优势能否支持价值捕获。候选池来自两者的交叉，而不是其中任何一项单独通过。全球定价权不是单一量化因子，仍需人工复核证据。
...
定价权是结果，护城河是可能维持这一结果的结构性原因。行业景气只能说明利润池可能扩大，不能说明所有公司都会受益；收入增长或市场份额也不能单独证明持久定价权。护城河档案要回答：公司是否依靠品牌、技术、成本、稀缺资源、渠道、转换成本、标准、牌照或生态位置，持续获取并保留行业利润，以及什么证据会否定这一机制。
...
这里的“全球”描述竞争环境，而不是上市地点或海外收入比例。A 股公司可以通过直接全球收入、进口替代、国际竞争力制造、全球定价资源，或受技术、认证、渠道保护的国内定价权体现这一能力。证据必须连接到价值捕获、利润留存或成本转嫁，并同时写明反证信号。

| 机制 | 证据需要检验什么 |
| --- | --- |
| 品牌与渠道 | 信任、分销和消费者心智能否守住价格或复购。 |
| 技术与标准 | 专利、认证、性能差异或生态锁定是否限制替代。 |
| 成本与供应链 | 全球规模、制造效率或稀缺投入控制能否保留利润。 |
| 资源与牌照 | 稀缺性、监管或准入是否形成可防守的经济位置。 |
| 转换成本与网络 | 兼容性、安装基础或服务生态能否留住客户。 |

护城河假设不自动等于全球定价权，排名中的公司也不会因为机器代理通过就被确认具备定价权。

**双门槛纪律：** 只有安全边际而没有持久价值捕获能力，可能是价值陷阱；只有定价权叙事而没有安全边际，可能是好公司但不是好价格。
...
- **锚仓：** 当前现金经济、行业位置和定价权/护城河代理较稳定；锚仓预算 65%，单股上限 15%。
